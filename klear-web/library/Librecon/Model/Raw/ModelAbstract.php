...
abstract class ModelAbstract implements \IteratorAggregate
{
     ...
     *
     * @var Librecon\Model\Raw\ModelAbstract
     */
    protected $_mapper;
    ...
    */
     ...
     *
     * @var Librecon\Model\ModelValidatorAbstract
     */
     ...
     *
     * @param array $data
     * @return Librecon\Model\Raw\ModelAbstract
     */
     ...
     *
     * @return Librecon\Model\Mapper\MapperAbstract
     */
     ...
     *
     * @param Librecon\Model\Mapper\MapperAbstract $mapper
     * @return Librecon\Model\Raw\ModelAbstract
     */
     ...
     *
     * @see Librecon\Mapper\DbTable\TableAbstract::getPrimaryKeyName()
     ...
     *
     * @see Librecon\Model\Mapper\MapperAbstract::toArray()
     * @return array
     */
     ...
     * Saves current row
     *
     * @see Librecon\Model\Mapper\MapperAbstract::save()
     ...
     *
     * @see Librecon\Model\Mapper\MapperAbstract::saveRecursive()
