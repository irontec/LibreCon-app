...
{
    /**
     * $_dbTable - instance of Librecon\Mapper\DbTable\TableAbstract
     *
     * @var Librecon\Mapper\DbTable\TableAbstract
     */
    protected $_dbTable;
     ...
     *
     * @param Librecon\Mapper\DbTable\TableAbstract $dbTable
     * @return Librecon\Mapper\Sql\Raw\MapperAbstract
     */
     ...
     * @param Librecon\Model\Raw\ModelAbstract $model
    ...
    public function loadRelated($type, $name, $model, $conditions = null, $orderBy = null)
    {
        ...
        if ('parent' == $type && array_key_exists($name, $parents)) {
            ...
            $table_class = 'Librecon\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
            ...
            $ref_table_name = 'Librecon\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
        } else {
        ...
        if ($this->_cache &&
            ...
            $relMapperClassName = "\\Librecon\\Mapper\\Sql\\" . $object_table_name;
     ...
     *
     * @see Librecon\Mapper\DbTable\TableAbstract::countAllRows()
     ...
     *
     * @see Librecon\Mapper\DbTable\TableAbstract::countByQuery()
     ...
     *
     * @param Librecon\Model\Raw\ModelAbstract $model The model to delete
     * @return int
     */
    public abstract function delete(\Librecon\Model\Raw\ModelAbstract $model);
    ...
    {
        $adapter = new \Librecon\Model\Paginator($select, $this);
     ...
     * @return Librecon\Model\Raw\ModelAbstract|null
     */
     ...
     * @return array All Librecon\Model\Raw\ModelAbstract meeting the criteria
     */
     ...
     * @param Librecon\Model\Raw\ModelAbstract|null $model
     * @return Librecon\Model\Raw\ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return Librecon\Mapper\DbTable\TableAbstract
     */
     ...
     *
     * @param new Librecon\Model\Raw\ModelAbstract $model
     * @return array
     */
     ...
     * @param Librecon\Model\Raw\ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
    protected abstract function loadModel($data, $entry);

    /**
     * Cleans urlIdentifier fields, so they can be used as url slugs
     * @param \Librecon\Model\Raw\ModelAbstract $model The model to clean
     *
     */
    protected function _setCleanUrlIdentifiers(\Librecon\Model\Raw\ModelAbstract $model)
    {
